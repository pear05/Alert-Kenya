...
--ring: 240 4.9% 83.9%;
  ...
  <aside class="w-64 bg-zinc-800 text-white h-screen">
    <div class="p-4">
      <img src="/logo.svg" alt="Logo" class="h-10 mb-4" />
      <h2 class="text-lg font-semibold">Admin</h2>
    </div>
    <nav class="mt-4">
      <ul>
        <li class="p-2 hover:bg-zinc-700"><a href="#">Dashboard</a></li>
        <li class="p-2 hover:bg-zinc-700"><a href="#">Admin Management</a></li>
        <li class="p-2 hover:bg-zinc-700"><a href="#">Company Management</a></li>
        <li class="p-2 hover:bg-zinc-700"><a href="#">Employee Management</a></li>
        <li class="p-2 hover:bg-zinc-700"><a href="#">Respond Management</a></li>
        <li class="p-2 hover:bg-zinc-700"><a href="#">Reports</a></li>
      </ul>
    </nav>
  ...
  <main class="flex-1 bg-zinc-100 p-6">
    ...
    <p class="text-zinc-600">Welcome to your admin dashboard</p>

    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
      <div class="bg-white p-4 rounded-lg shadow">
        <h2 class="text-lg font-semibold">Number of Users</h2>
        <p class="text-3xl">00</p>
      </div>
      <div class="bg-white p-4 rounded-lg shadow">
        <h2 class="text-lg font-semibold">Times Spent</h2>
        <p class="text-3xl">00</p>
      </div>
      <div class="bg-white p-4 rounded-lg shadow">
        <h2 class="text-lg font-semibold">Number of Alerts</h2>
        <p class="text-3xl">00</p>
      </div>
      <div class="bg-white p-4 rounded-lg shadow">
        <h2 class="text-lg font-semibold">Number of Responses</h2>
        <p class="text-3xl">00</p>
      </div>
    </div>

    <h2 class="text-xl font-bold mt-8">Daily Reports</h2>
    <p class="text-zinc-600">Nairobi, Kenya</p>

    <h2 class="text-xl font-bold mt-8">Total Stats Reports</h2>
    <p class="text-zinc-600">Nairobi, Kenya</p>
